...
<head>
    ...
    <title>Eye Donation Registration</title>
    <style>
    body {
...
<h2><center>Eye Donation Registration</center></h2>    
...
<!-- 
    <label for="award_money">Receive Money:</label>
    <input type="checkbox" id="award_money" name="award_money"><br><br> -->
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO register (id, name, age, gender, phone, bloodType,DOB,ProofType,ProofNo, dateOfRegister,password, registerFor)
            VALUES ('$registerID', '$name', '$age', '$gender', '$phone', '$bloodgroup','$dob','$prooftype','$proofno', '$date','$password', 'donate')";
